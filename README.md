...
<p align="left">Я легко адаптируюсь к разным задачам ( разработчик приложений 📱 или дизайнер начального уровня 🎨) в зависимости от того, чего требует проект. Мне нравится исследовать мир IT 💻 и использовать мои знания  для создания крутых вещей 🛠️..</p>
